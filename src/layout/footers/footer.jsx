...
const Footer = () => {
  ...
  const email = cleanStr(office?.primaryEmail);
                    ...
                    <div className="age-talkAddress">
                      ...
                      >
                        ...
                        <div className="age-addrLines">
                          {splitLines(officeAddress).slice(0, 4).map((l, i) => (
                            <div key={i}>{l}</div>
                          ))}
                        </div>
                      </a>
          ...
          <div className="age-container">
            <div className="age-bottomWrap">
              ...
              <p className="age-copy">
                <strong>© {new Date().getFullYear()} {office?.legalName || office?.name || "Company"}. All rights reserved under applicable laws.</strong>
              </p>
