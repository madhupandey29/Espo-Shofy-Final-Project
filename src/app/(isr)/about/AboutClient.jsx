...
const AboutClient = ({ authors = [], office = null }) => {
  ...
  // Simulate loading/error states based on data availability
  const authorLoading = false; // Data is fetched server-side, so no loading state
  const authorError = false; // If there was an error, authors would be empty array
